...
async def list_dns_records(
    ...
    tool_type = type_registry.lookup_tool("unifi_list_dns_records")
    if tool_type is not None:
        ...
        hint = registry.render_hint_for_tool("unifi_list_dns_records")
    return {
        "items": rows,
...
async def get_dns_record_details(
    ...
    type_registry = request.app.state.type_registry
    tool_type = type_registry.lookup_tool("unifi_get_dns_record_details")
    if tool_type is not None:
        type_class, kind = tool_type
        ...
        hint = registry.render_hint_for_tool("unifi_get_dns_record_details")
