...
# Legacy V1 firewall policy schemas were removed in #210 — the V1 code path
# was never functional on modern firmware. Canonical schemas are
# FIREWALL_POLICY_V2_CREATE_SCHEMA / FIREWALL_POLICY_V2_UPDATE_SCHEMA below.
...
# FIREWALL_POLICY_SIMPLE_SCHEMA was removed in #210 along with the
# unifi_create_simple_firewall_policy tool.
