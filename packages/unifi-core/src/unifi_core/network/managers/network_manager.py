...
_FIREWALL_ZONES_FULL_CACHE_PREFIX = "firewall_zones_full"
_VPN_FIREWALL_ZONE_ERROR = (
    ...
    "Select the system-defined Vpn zone from unifi_list_firewall_zones; no network mutation was attempted."
)
...
class NetworkManager:
    ...
    async def _get_firewall_zone_record(self, zone_id: Any) -> Dict[str, Any]:
        ...
        cache_key = f"{_FIREWALL_ZONES_FULL_CACHE_PREFIX}_{self._connection.site}"
        zones = self._connection.get_cached(cache_key)
    ...
    async def validate_firewall_zone_assignment(
        ...
        purpose_is_changing = "purpose" in update_data
