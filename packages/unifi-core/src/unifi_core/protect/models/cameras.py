...
class Camera(BaseModel):
    ...
    channels: Optional[Dict[str, Any]] = Field(default=None, description="Channel configuration (JSON pass-through)", json_schema_extra={"mutable": False})
    ...
    ir_led_mode: Optional[Literal["auto", "on", "off", "autoFilterOnly"]] = Field(default=None, description="IR LED mode")
    hdr_mode: Optional[Literal["auto", "off", "always"]] = Field(default=None, description="HDR mode")
